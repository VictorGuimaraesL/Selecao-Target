...
arquivojson = 'Documents\dados.json'# Substitua pelo caminho do arquivo .json
menor, maior, dias_acima_media = analisar_faturamento(arquivojson) #Chama a função utilizando o arquivo .json
...
arquivoxml = "Documents\dados (2).xml"# Substitua pelo caminho do arquivo .xml
menor, maior, dias_acima_media = analisar_faturamento(arquivoxml) #Chama a função utilizando o arquivo .xml
